<img src="/media/avatar.png" alt="Daniel Morgan profile photo" class="w-24">

<h2 class="text-2xl font-semibold text-blue-darkest mt-2">Daniel Morgan</h2>

<p class="text-blue-darkest">I write code that works (usually).</p>

<nav class="mt-4 md:mt-8">
    <ul class="MainNav list-reset">
        <li>
            <a href="/" class="MainNav__link {{ $page->selected('about') }}">
                About me
            </a>
        </li>
        <li>
    ...
    <div class="mt-4 md:mt-8">
        <a href="https://twitter.com/Morgan345" title="Follow me on Twitter" class="mr-2 no-underline">
            <svg class="h-6" viewBox="0 0 32 32">
        ...
        <a href="https://github.com/danielmorgan" title="Personal projects on GitHub" class="mr-2 no-underline">
            <svg class="h-6" viewBox="0 0 32 32">
        ...
        <a href="https://www.linkedin.com/in/morgan345/" title="Work history on LinkedIn" class="mr-2 no-underline">
            <svg class="h-6" viewBox="0 0 32 32">
        ...
        <a href="mailto:me+from-personal-site@danielmorgan.co.uk" title="Email me+from-personal-site@danielmorgan.co.uk" class="mr-2 no-underline">
            <svg class="h-6" viewBox="0 0 32 32">
